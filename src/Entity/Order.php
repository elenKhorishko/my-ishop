...
class Order
{
     ...
     * @var float
     *
     * @ORM\Column(type="decimal", scale=2, precision=20)
     */
    private $amount;
     ...
     * @return \DateTime
     */
    public function getCrestedAt(): \DateTime
    {
        return $this->crestedAt;
    }

    /**
     * @param \DateTime $crestedAt
     * @return Order
     */
    public function setCrestedAt(\DateTime $crestedAt): Order
    {
        $this->crestedAt = $crestedAt;
        return $this;
    }
    ...
    {
        return self::$statuses[$this->status]; // вернем значение из массива для текущего статуса
    }
