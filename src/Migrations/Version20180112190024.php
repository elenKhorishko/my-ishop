 ...
 */
class Version20180112190024 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, crested_at DATETIME NOT NULL, count INT NOT NULL, amount NUMERIC(20, 2) NOT NULL, phone VARCHAR(250) NOT NULL, email VARCHAR(250) NOT NULL, address LONGTEXT DEFAULT NULL, status SMALLINT NOT NULL, is_paid TINYINT(1) NOT NULL, INDEX IDX_E52FFDEEA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
